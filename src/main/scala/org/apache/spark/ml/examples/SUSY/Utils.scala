...
package org.apache.spark.ml.examples.SUSY
...
//              featuresFile: String = "./data/uci_adult/features",
              trainFile: String = "C:/dataset/susy/SUSY.data",
              testFile: String = "C:/dataset/susy/SUSY.test",
              featuresFile: String = "C:/dataset/susy/features",
